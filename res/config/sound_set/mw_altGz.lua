...
return {
	tracks = {
		{ name = "vehicle/mw_altGz/start.wav", refDist = 3.0 },
		{ name = "vehicle/mw_altGz/slow.wav", refDist = 3.0 },
		{ name = "vehicle/mw_altGz/normal.wav", refDist = 3.0 },
		{ name = "vehicle/mw_altGz/fast.wav", refDist = 3.0 },
